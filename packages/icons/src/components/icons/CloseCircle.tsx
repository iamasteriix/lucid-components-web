...
const CloseCircleSolid = createIcon({
  paths: [{
...
const CloseCircleSolidDuo = createIcon({
  paths: [
    {
...
const CloseCircleOutline = createIcon({
  paths: [
    {
...
const CloseCircleOutlineDuo = createIcon({
  paths: [
    {
...
export const CloseCircle: IconComponent = ({
  viewBox = '0 0 24 24',
  size = '1rem',
  fill = '#f0fefe',
  variant = 'monochrome',
  ...
  const SelectedIcon = isDuotone && solid ? CloseCircleSolidDuo
    : isDuotone ? CloseCircleOutlineDuo
    : solid ? CloseCircleSolid
    : CloseCircleOutline;
